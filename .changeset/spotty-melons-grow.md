...
- Migrated the test suite from PHPUnit to Pest with 100% line coverage of `src/`.
- Added GitHub Actions CI running Pest with a `--min=100` coverage gate across a PHP 8.3/8.4/8.5 matrix.
